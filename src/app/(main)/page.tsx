...
function HeroSection() {
  return (
    <section className="relative bg-pm overflow-hidden py-20 md:py-28">
      ...
      <div className="pointer-events-none absolute -top-32 -right-32 h-[500px] w-[500px] rounded-full bg-pm-accent/10 blur-3xl" />
      {/* Radial glow bottom-left */}
      <div className="pointer-events-none absolute -bottom-20 -left-20 h-[360px] w-[360px] rounded-full bg-pm-yellow/10 blur-3xl" />

      <div className="container relative mx-auto px-4">
        <div className="mx-auto max-w-3xl text-center">
          {/* Pill badge */}
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-pm-accent/30 bg-pm-accent/10 px-4 py-1.5 text-sm text-pm-accent animate-fade-in">
            <Star className="h-3.5 w-3.5 fill-pm-accent" />
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-5 leading-tight animate-slide-in">
            Buy &amp; Sell
            <span className="text-pm-accent"> Anything </span>
            in Pakistan
          </h1>
          ...
          >
            ...
            <button
              type="submit"
              className="m-1.5 shrink-0 rounded-full bg-pm-accent px-6 py-2.5 text-sm font-semibold text-pm transition-all hover:brightness-110 active:scale-95"
            >
              Search
            </button>
          </form>
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-10 animate-fade-in">
            {quickCategories.map((cat) => (
              <Link
                ...
                className="rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-sm text-white/90 backdrop-blur-sm transition-all hover:bg-pm-accent hover:text-pm hover:border-pm-accent font-medium"
              >
                {cat.label}
              </Link>
            ))}
          ...
          <Link href="/post-ad">
            <Button
              size="lg"
              className="bg-pm-yellow text-pm hover:bg-pm-yellow/90 gap-2 rounded-full px-8 font-bold shadow-lg shadow-pm-yellow/20 transition-all hover:scale-105 active:scale-100"
            >
          ...
          <div className="mt-12 grid grid-cols-3 gap-4 border-t border-white/10 pt-10">
            {[
              ...
              <div key={label} className="flex flex-col items-center gap-1.5">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-pm-accent/15">
                  <Icon className="h-5 w-5 text-pm-accent" />
                </div>
    ...
    <section className="py-14 bg-gray-50/60">
      <div className="container mx-auto px-4">
        <div className="mb-8 flex items-end justify-between">
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest text-pm-accent mb-1">
              Explore Locally
            </p>
          ...
          <Link
            href="/search"
            className="flex items-center gap-1 text-sm font-medium text-pm hover:text-pm-accent transition-colors"
          >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
          {majorCities.map((city) => (
            <Link
              ...
              className="group flex flex-col items-center gap-2 rounded-xl border border-gray-200 bg-white p-4 text-center shadow-sm transition-all duration-200 hover:border-pm-accent/50 hover:shadow-md hover:-translate-y-0.5"
            >
              <span className="text-3xl">{city.emoji}</span>
              <p className="font-semibold text-sm text-gray-900 group-hover:text-pm">
                {city.name}
              </p>
  ...
  const features = [
    {
      ...
      color: 'bg-pm-accent/10',
      iconColor: 'text-pm-accent',
      borderColor: 'border-pm-accent/20',
    },
    {
      icon: Shield,
      title: 'Verified Sellers',
      desc: 'Every seller goes through our verification process so you can buy with confidence.',
      color: 'bg-pm-yellow/10',
      iconColor: 'text-pm-yellow',
      borderColor: 'border-pm-yellow/20',
    },
    {
      icon: MessageCircle,
      title: 'Secure Chat',
...
async function FeaturedAdsSection() {
  ...
  return (
    <section className="py-14 bg-gradient-to-b from-pm-yellow/8 via-pm-yellow/5 to-transparent">
      <div className="container mx-auto px-4">
        <div className="mb-8 flex items-end justify-between">
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest text-pm-yellow mb-1">
              Promoted Listings
            </p>
...
function DownloadAppSection() {
  return (
    <section className="py-16 bg-pm-light overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="relative flex flex-col md:flex-row items-center justify-between gap-10 rounded-3xl bg-pm p-10 md:p-14 overflow-hidden">
          {/* Grid overlay */}
          <div
          ...
          />
          <div className="pointer-events-none absolute -top-24 -right-24 h-96 w-96 rounded-full bg-pm-accent/10 blur-3xl" />

          {/* Text */}
          <div className="relative z-10 flex-1 text-center md:text-left">
            <p className="text-xs font-semibold uppercase tracking-widest text-pm-accent mb-2">
              Available Now
            </p>
          ...
          <div className="relative z-10 flex items-center justify-center">
            <div className="relative">
              {/* Glow ring */}
              <div className="absolute inset-0 rounded-[2.5rem] bg-pm-accent/20 blur-2xl scale-110" />
              <div className="relative flex flex-col items-center justify-center h-[280px] w-[140px] rounded-[2.5rem] border-4 border-white/20 bg-pm-light shadow-2xl overflow-hidden">
                {/* Status bar */}
...
function ReadyToSellSection() {
  return (
    <section className="relative py-20 bg-pm overflow-hidden">
      {/* Dot pattern overlay */}
      <div
      ...
      />
      {/* Glows */}
      <div className="pointer-events-none absolute -top-20 left-1/2 -translate-x-1/2 h-[400px] w-[700px] rounded-full bg-pm-accent/10 blur-3xl" />

      <div className="container relative mx-auto px-4 text-center">
        <div className="inline-flex items-center gap-2 rounded-full border border-pm-yellow/30 bg-pm-yellow/10 px-4 py-1.5 text-sm text-pm-yellow mb-6">
          <Star className="h-3.5 w-3.5 fill-pm-yellow" />
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <Link href="/post-ad">
            <Button
              size="lg"
              className="bg-pm-yellow text-pm hover:bg-pm-yellow/90 gap-2 rounded-full px-10 font-bold shadow-xl shadow-pm-yellow/20 transition-all hover:scale-105 active:scale-100"
            >
              <Plus className="h-5 w-5" />
              Post Your Ad Now
            </Button>
