          ...
          <div className="mb-8">
            ...
            >
              <input
                ...
                className="w-full h-12 pl-12 pr-4 rounded-lg border border-gray-200 bg-white focus:outline-none focus:ring-2 focus:ring-pm-accent focus:border-transparent"
              />
